    ...
    <div className="text-center py-12 bg-gray-50 my-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-6">
        ...
        <div className="flex flex-col items-center p-6 bg-white shadow-lg rounded-lg">
          ...
          <Link to={`/consulting`} className="btn btn-primary bg-green-400 text-white">Learn More</Link>
        </div>
        ...
        <div className="flex flex-col items-center p-6 bg-white shadow-lg rounded-lg">
          ...
          <Link to={`/software`} className="btn btn-primary bg-green-400 text-white">Learn More</Link>
        </div>
        ...
        <div className="flex flex-col items-center p-6 bg-white shadow-lg rounded-lg">
          ...
          <Link to={'/digital'} className="btn btn-primary bg-green-400 text-white">Learn More</Link>
        </div>
        ...
        <div className="flex flex-col items-center p-6 bg-white shadow-lg rounded-lg">
          ...
          <Link to={'/cloud'} className="btn btn-primary bg-green-400 text-white">Learn More</Link>
        </div>
        ...
        <div className="flex flex-col items-center p-6 bg-white shadow-lg rounded-lg">
          ...
          <Link to={'/It'} className="btn btn-primary bg-green-400 text-white">Learn More</Link>
        </div>
        ...
        <div className="flex flex-col items-center p-6 bg-white shadow-lg rounded-lg">
          ...
          <Link to={'/cybersecurity'} className="btn btn-primary bg-green-400 text-white">Learn More</Link>
        </div>
