  ...
  <div className="card bg-base-100 w-full max-w-sm shrink-0 shadow-2xl">
    <form onSubmit={handleService} className="card-body">
      <div className="form-control">
        ...
        <input name="image" type="url" placeholder="Upload your image"
      ...
      <div className="form-control">
        ...
        <input name="name" type="text" placeholder="name" className="input input-bordered input-success w-full max-w-xs"
          required />
      </div>
      <div className="form-control">
        <label className="label">
        ...
        <input name="website" type="url" placeholder="website link"
          className="input input-bordered input-success w-full max-w-xs" required />
      </div>
      <div className="form-control">
        <label className="label">
        ...
        <textarea name="desc" className="textarea textarea-accent" placeholder="Bio"></textarea>
      </div>
      <div>
      ...
      {/* date */}
      <DatePicker selected={startDate} className="input input-bordered input-success w-full max-w-xs" onChange={(date)=>
